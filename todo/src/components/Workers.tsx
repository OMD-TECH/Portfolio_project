    ...
    >
      ...
      <div className="flex justify-center items-center">
        {currentObject && (
          ...
          >
            <p className="pt-4 md:pt-0">{currentObject.desc}</p>
      ...
      <div
        className="rounded-full p-5 font-bold bg-white text-white absolute right-10 top-[50%] cursor-pointer"
      ...
      <div
        className="rounded-full p-5 font-bold bg-white text-white absolute left-10 top-[50%] cursor-pointer"
